...
public class TimeEntryControllerTest {
    ...
    private GaugeService mockGuageService;
    ...
    public void setUp() throws Exception {
        ...
        mockGuageService = mock(GaugeService.class);
        mockCounterService = mock(CounterService.class);
        controller = new TimeEntryController(timeEntryRepository, mockCounterService, mockGuageService);
    }
